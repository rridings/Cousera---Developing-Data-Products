...
subtitle    : 30 year monthly averages across the US
author      : Rob Ridings
...
```
<br>
Maximum Temperature: `r format(round(w$tmax,0), nsmall=0)` F<br>
Minimum Temperature: `r format(round(w$tmin,0), nsmall=0)` F<br>
Snowfall: `r format(round(w$snow,2), nsmall=2)` inches<br>
